...
{
	$ret = false;
	//jquery_is_already, load main jQuery library ?
...
/* ------------------------------------------------- */
/*  assign array for  etc.                            */
/*  xoops_module_header js file name array            */
/* ------------------------------------------------- */
if(isset($this->_tpl_vars["xoops_module_header"])){
...
{
	// concatenation of non-empty matches from the conditional sub-pattern
	$match =array();
	if (empty($document)){
		return array();
	}
